...
const InternshipPage = () => {
  ...
  return (
    <div className={styles.section} ref={containerRef}>
      {/* Background is now simplified via CSS */}
          ...
          <div className={styles.contactGrid}>
            ...
            <aside className={styles.sidebar}>
              <div className={styles.infoCard}>
                ...
                <span className={styles.infoText}>hr@softnovatechnology.com</span>
              </div>
              <div className={styles.infoCard}>
                <div className={styles.iconCircle}>
              ...
              <div className={styles.socialProfiles}>
                ...
                <div className={styles.socialIcons}>
                  ...
                  <a href="https://in.linkedin.com/company/softnovatech" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                  ...
                  <a href="https://www.instagram.com/softnova_academy?igsh=MW9nNDhieXE1ZndpNA==" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                    <Instagram size={20} />
                  </a>
                </div>
              </div>
